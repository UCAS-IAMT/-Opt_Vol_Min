% ---------------------------------------------------------------------------------------
% To run the code use: opt_volmin3d(60, 20, 4, 3.16, 3.0, 1.5)
...
% ---------------------------------------------------------------------------------------
function opt_volmin3d(nelx,nely,nelz,Ctarget,penal,rmin)
...
[il,jl,kl] = meshgrid(nelx, 0, 0:nelz);                 % Node coordinates (x, y, z)
...
title('Convergence History $C/C_0$', 'FontSize', 30, 'FontWeight','bold');
legend([h1, h2, yline_left], ...
    {'Compliance Ratio','Volume Fraction','Target Compliance'}, 'Location','best', 'FontSize', 24, 'Box','on','Interpreter','latex');
